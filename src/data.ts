...
export const INITIAL_USERS: User[] = [
  {
    id: 'U-001',
    name: 'Jean-Claude Kabera',
    email: 'j.kabera@authority.gov.rw',
    ...
    idNumber: '1198580012345678',
    phone: '+250 788 111 222',
    position: 'Sector Agronomist',
    lastActive: 'Today, 10:45 AM',
    permissions: 'Level 2 (Authorized)'
  },
  {
    id: 'U-002',
    name: 'Marie-Rose Mutoni',
    email: 'm.mutoni@authority.gov.rw',
    ...
    idNumber: '1199080087654321',
    phone: '+250 788 222 333',
    position: 'Cell Social Affairs Secretary',
  ...
  },
  {
    ...
    idNumber: '1198080023456123',
    phone: '+250 788 333 444',
    position: 'External IT Specialist',
  ...
  },
  {
    id: 'U-004',
    name: 'Alice Nirere',
    email: 'a.nirere@authority.gov.rw',
    role: 'Meeting Secretary',
    status: 'Active',
    sector: 'Gasabo',
    cell: 'Kimironko',
    ...
    idNumber: '1199580045612347',
    phone: '+250 788 444 555',
    position: 'Cell Executive Secretary Assist',
